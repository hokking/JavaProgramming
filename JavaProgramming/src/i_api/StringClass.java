...
public class StringClass {
	...
	public static void main(String[] args) {
		...
		String str1 = "문자열";
		str1="추가"; // 문자열은 변경이 되면 객체를 새로 만든다
		String str2 = null;
		System.out.println(str1.equals(str2)); // 파라미터에는 null이 들어갈 수 있지만 변수에는
												// null이 들어갈 수 없음
		...
		System.out.println(sub2); // 끝나는 인덱스는 내용에 포함되지 않는다.
		...
		String[] menu = { "수박 2000원", "오렌지 100000원", "귤 500원", "블루베리 3000원" };
		...
		str = "    문자열          ";
		String trim = str.trim(); // 문자열 사이에 있는 공백은 없애주지 않는다
